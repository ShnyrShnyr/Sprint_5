...
class TestExit:
    def test_exit(self, driver):
        driver.find_element(*MainPageLocators.ENTER_BUTTON).click() # на главной странице находим и нажимаем войти в аккаунт
        ...
        WebDriverWait(driver, 20).until(ec.visibility_of_element_located(MainPageLocators.PERSONAL_ACCOUNT)).click() # ждем загрузки кнопки Личный кабинет на главной странице и нажимаем на него.
